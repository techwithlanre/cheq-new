  ...
  return Form(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 20,),
        dropdownWrapper(dropdownField('password',
            hint: 'Select your currency', list: genderOptions
        ), "Currency"),
        const SizedBox(height: 20,),
        dropdownWrapper(dropdownField('currency_id',
            hint: 'Select your business category', list: genderOptions
        ), "Business Category"),
        Container(
